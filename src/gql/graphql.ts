...
export const ApplicantIndividualCompanyPositionsDocument = new TypedDocumentString(`
  ...
  applicantIndividualCompanyPositions {
    ...
    `) as unknown as TypedDocumentString<ApplicantIndividualCompanyPositionsQuery, ApplicantIndividualCompanyPositionsQueryVariables>;
export const ApplicantIndividualCompanyRelationsDocument = new TypedDocumentString(`
  ...
  applicantIndividualCompanyRelations {
    ...
    `) as unknown as TypedDocumentString<ApplicantIndividualCompanyRelationsQuery, ApplicantIndividualCompanyRelationsQueryVariables>;